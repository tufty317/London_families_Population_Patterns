...
colours = c("Immigration" = "#943fa6", "Emmigration" = "#63c5b5", "Net International migration" = "#eb861e")
...
int_mig_seg2 <- ggplot(data = MYE2022data_ed) +
  theme_gla() +
  geom_segment(aes(x=Int_out_K, y =Name, xend = 0, yend = Name, colour = "Emmigration"), size = 5, lineend = "butt", alpha = 0.5) +
