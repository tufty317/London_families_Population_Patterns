...
London_ageStructure_2021 <- Census_total_byLondon %>%
    ...
    theme_gla()+
    geom_bar(aes(fill = ""), stat = "identity", fill="#943fa6") +
  ...
  theme(axis.text = element_text(size = 16)) +
    labs(title= "Age structure of London in 2021", 
         ...
         y = "Population (thousands)",
     caption = paste0("Source: ONS, Chart: GLA demography"))
London_ageStructure_2021 

ggsave (filename = (paste0(chart_dir, "London_ageStructure_2021.png")),
         plot = London_ageStructure_2021,
         device = "png",
         dpi=600,
         width = 9,
         height = 12,
